...
// RestCountries SDK utility: fetcher
...
class RestCountriesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; RestCountriesSDK/1.0)';
    ...
    public static function call(RestCountriesContext $ctx, string $fullurl, array $fetchdef): array
    {
