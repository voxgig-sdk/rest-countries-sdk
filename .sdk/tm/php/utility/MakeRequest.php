...
class RestCountriesMakeRequest
{
    public static function call(RestCountriesContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new RestCountriesResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new RestCountriesResponse($fetched);
        } else {
