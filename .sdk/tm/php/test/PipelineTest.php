...
// RestCountries SDK pipeline test
//
...
{
    private static function utility(): RestCountriesUtility
    {
        return new RestCountriesUtility();
    }
    ...
    private static function ctx(array $over = []): RestCountriesContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new RestCountriesContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new RestCountriesOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof RestCountriesError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new RestCountriesOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = RestCountriesMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new RestCountriesOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = RestCountriesMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new RestCountriesOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = RestCountriesMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RestCountriesSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = RestCountriesMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            ...
            'result' => new RestCountriesResult([]),
        ]);
        [, $err] = RestCountriesMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new RestCountriesSpec([]),
            'response' => null,
            'result' => new RestCountriesResult([]),
        ]);
        [, $err] = RestCountriesMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new RestCountriesSpec(['step' => 's']),
            'response' => new RestCountriesResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new RestCountriesResult([]),
        ]);
        [, $err] = RestCountriesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new RestCountriesSpec(['step' => 's']),
            'response' => new RestCountriesResponse(self::resp(200, ['v' => 1])),
            'result' => new RestCountriesResult([]),
        ]);
        [, $err] = RestCountriesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new RestCountriesSpec(['step' => 's']),
            'response' => new RestCountriesResponse(self::resp(200, ['v' => 2])),
            'result' => new RestCountriesResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        RestCountriesMakeResponse::call($ctx);
    ...
    {
        $preset = new RestCountriesResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new RestCountriesSpec([]),
            'response' => new RestCountriesResponse([]),
            'result' => new RestCountriesResult([]),
        ...
        [$got, $err] = RestCountriesMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new RestCountriesResult([])]);
        [, $err] = RestCountriesMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new RestCountriesSpec([]), 'result' => null]);
        [, $err] = RestCountriesMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RestCountriesSpec(['step' => 's']),
            'result' => new RestCountriesResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new RestCountriesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RestCountriesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RestCountriesSpec(['step' => 's']),
            'result' => new RestCountriesResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new RestCountriesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RestCountriesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RestCountriesResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new RestCountriesSpec([]),
            'result' => new RestCountriesResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = RestCountriesMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RestCountriesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new RestCountriesError('boom', 'boom');
        $utility->fetcher = function (RestCountriesContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RestCountriesSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = RestCountriesMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (RestCountriesContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = RestCountriesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(RestCountriesResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        RestCountriesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (RestCountriesContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RestCountriesSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = RestCountriesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new RestCountriesResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new RestCountriesSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = RestCountriesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = RestCountriesMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = RestCountriesMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new RestCountriesResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, RestCountriesDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new RestCountriesResult(['ok' => false])]);
        $this->expectException(RestCountriesError::class);
        RestCountriesDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new RestCountriesResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', RestCountriesMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        RestCountriesMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new RestCountriesBaseFeature();
        $b = new RestCountriesBaseFeature();
        RestCountriesFeatureAdd::call($ctx, $a);
        RestCountriesFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): RestCountriesBaseFeature
    {
        $f = new RestCountriesBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        RestCountriesFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): RestCountriesContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new RestCountriesSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RestCountriesPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        RestCountriesPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new RestCountriesResponse(['headers' => null]),
            'result' => new RestCountriesResult([]),
        ]);
        RestCountriesResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        RestCountriesResultBody::call($ctx);
