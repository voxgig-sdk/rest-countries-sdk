...
// RestCountries SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = RestCountriesOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(RestCountriesOmni::structfix($now, Struct::undef()))
                        !== json_encode(RestCountriesOmni::structfix($val, Struct::undef()))) {
