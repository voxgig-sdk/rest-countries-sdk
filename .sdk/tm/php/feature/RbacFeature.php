...
// RestCountries SDK rbac feature
...
class RestCountriesRbacFeature extends RestCountriesBaseFeature
{
    ...
    private function _required(RestCountriesContext $ctx): ?string
    {
    ...
    private function _reject(RestCountriesContext $ctx, string $required): void
    {
    ...
    private function _track(RestCountriesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
