...
// RestCountries SDK cache feature
...
class RestCountriesCacheFeature extends RestCountriesBaseFeature
{
    ...
    private function _through(RestCountriesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
