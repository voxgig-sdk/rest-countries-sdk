...
// RestCountries SDK clienttrack feature
...
class RestCountriesClienttrackFeature extends RestCountriesBaseFeature
{
    ...
    public function PostConstruct(RestCountriesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'RestCountries-SDK';
