...
// RestCountries SDK timeout feature
...
class RestCountriesTimeoutFeature extends RestCountriesBaseFeature
{
    ...
    private function _with_timeout(RestCountriesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RestCountriesContext $_ctx, float $ms): void
    {
        $client = $this->client;
