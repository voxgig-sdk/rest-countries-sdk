...
// RestCountries SDK netsim feature
...
class RestCountriesNetsimFeature extends RestCountriesBaseFeature
{
    ...
    private function _simulate(RestCountriesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RestCountriesContext $ctx, array $applied): void
    {
        $client = $this->client;
