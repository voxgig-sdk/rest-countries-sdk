...
// RestCountries SDK audit feature
...
class RestCountriesAuditFeature extends RestCountriesBaseFeature
{
    ...
    private function _emit(RestCountriesContext $ctx, string $outcome): void
    {
