...
class RestCountriesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = RestCountriesTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = RestCountriesTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = RestCountriesTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
