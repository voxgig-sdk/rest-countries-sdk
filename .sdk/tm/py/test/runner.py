...
class RestCountriesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = RestCountriesTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = RestCountriesTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = RestCountriesTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
