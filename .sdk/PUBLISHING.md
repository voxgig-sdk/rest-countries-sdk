...
|---|---|---|
| `ts/` | @voxgig-sdk/rest-countries-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/rest-countries-sdk \
      --repository voxgig-sdk/rest-countries-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/rest-countries-sdk` shows it, and
`npm trust revoke @voxgig-sdk/rest-countries-sdk --id=<id>` removes it.
