...
-- by passing it.
function RestCountriesSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function RestCountriesSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "RestCountriesSDK: graphql: " .. msg
    res.graphql = errors
  end
