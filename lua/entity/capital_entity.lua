-- RestCountries SDK Capital entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local CapitalEntity = {}
CapitalEntity.__index = CapitalEntity


function CapitalEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CapitalEntity)
  self._name = "capital"
  self._client = client
...
function CapitalEntity:get_name()
  return self._name
end


function CapitalEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CapitalEntity.new(self._client, opts)
end
...
function CapitalEntity:mark_deleted()
  self._deleted = true
end


function CapitalEntity:deleted()
  return true == self._deleted
end


function CapitalEntity:data_set(args)
  if args ~= nil then
...
function CapitalEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CapitalEntity:match_set(args)
  if args ~= nil then
...
function CapitalEntity:match_get()
...
function CapitalEntity:stream(action, args, callopts)
...
---@param reqmatch CapitalLoadMatch
---@param ctrl? table
---@return Capital
---@return string? err
function CapitalEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function CapitalEntity:_run_op(ctx, post_done)
  local utility = self._utility
