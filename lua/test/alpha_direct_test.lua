...
describe("AlphaDirect", function()
  it("should direct-load-alpha", function()
    local setup = alpha_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-alpha", setup.live and "live" or "unit")
...
function alpha_direct_setup(mockres)
