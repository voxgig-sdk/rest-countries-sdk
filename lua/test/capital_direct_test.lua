...
describe("CapitalDirect", function()
  it("should direct-load-capital", function()
    local setup = capital_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-capital", setup.live and "live" or "unit")
...
function capital_direct_setup(mockres)
