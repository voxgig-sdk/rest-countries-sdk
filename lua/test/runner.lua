...
function runner.env_override(m)
  local live = runner.getenv("REST_COUNTRIES_TEST_LIVE")
  local override = runner.getenv("REST_COUNTRIES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("REST_COUNTRIES_TEST_EXPLAIN")
