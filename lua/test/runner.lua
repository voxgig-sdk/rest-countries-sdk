...
function runner.env_override(m)
  local live = runner.getenv("RESTCOUNTRIES_TEST_LIVE")
  local override = runner.getenv("RESTCOUNTRIES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("RESTCOUNTRIES_TEST_EXPLAIN")
