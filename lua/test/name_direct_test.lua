...
describe("NameDirect", function()
  it("should direct-load-name", function()
    local setup = name_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-name", setup.live and "live" or "unit")
...
function name_direct_setup(mockres)
