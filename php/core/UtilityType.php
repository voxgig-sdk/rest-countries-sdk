...
// RestCountries SDK utility type

class RestCountriesUtility
{
    ...
    public static function copy(RestCountriesUtility $src): RestCountriesUtility
    {
        $u = new RestCountriesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
