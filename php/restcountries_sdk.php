...
class RestCountriesSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = RestCountriesHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = RestCountriesHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!RestCountriesFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, RestCountriesFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return RestCountriesUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = RestCountriesHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = RestCountriesHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = RestCountriesHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new RestCountriesError($op . "_allow",
                "RestCountriesSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = RestCountriesHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new RestCountriesError("graphql_error",
                "RestCountriesSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Alpha($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_alpha === null) {
                $this->_alpha = new AlphaEntity($this, null);
            }
            return $this->_alpha;
        }
        return new AlphaEntity($this, $data);
    }
    ...
    public function Capital($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_capital === null) {
                $this->_capital = new CapitalEntity($this, null);
            }
            return $this->_capital;
        }
        return new CapitalEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new RestCountriesSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
