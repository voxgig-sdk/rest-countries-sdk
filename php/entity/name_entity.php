...
class NameEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NameEntity($this->_client, $opts);
    }

    /**
     * @param Name|array $args Name data (assoc-array) to store.
     */
    ...
    /**
     * @return Name|array The current Name data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Name fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Name fields).
     */
     ...
     * Load a single Name.
     *
     * @param NameLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NameLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Name|array The loaded Name as an assoc-array at the
