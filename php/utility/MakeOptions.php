...
// RestCountries SDK utility: make_options

class RestCountriesMakeOptions
{
    ...
    public static function call(RestCountriesContext $ctx): array
    {
        ...
        //
        // `RestCountriesSchema::optspec()` is built from the model:
        ...
        $optspec = RestCountriesSchema::optspec();
