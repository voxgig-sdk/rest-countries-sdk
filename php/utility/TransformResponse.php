...
// RestCountries SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class RestCountriesTransformResponse
{
    public static function call(RestCountriesContext $ctx): mixed
    {
        ...
        $transform = RestCountriesHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
