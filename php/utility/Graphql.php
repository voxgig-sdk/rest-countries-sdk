...
// RestCountries SDK utility: graphql
//
...
class RestCountriesGraphql
{
    ...
    // equivalent.
    public static function body(RestCountriesContext $ctx): mixed
    {
    ...
    public static function errors(RestCountriesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
