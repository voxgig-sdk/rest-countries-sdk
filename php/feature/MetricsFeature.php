...
// RestCountries SDK metrics feature
...
class RestCountriesMetricsFeature extends RestCountriesBaseFeature
{
    ...
    private function _record(RestCountriesContext $ctx, bool $ok): void
    {
