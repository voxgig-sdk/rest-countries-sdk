...
// RestCountries SDK telemetry feature
...
class RestCountriesTelemetryFeature extends RestCountriesBaseFeature
{
    ...
    private function _close(RestCountriesContext $ctx, bool $ok): void
    {
