...
// RestCountries SDK debug feature
...
class RestCountriesDebugFeature extends RestCountriesBaseFeature
{
    ...
    private function _finish(RestCountriesContext $ctx, bool $ok): void
    {
