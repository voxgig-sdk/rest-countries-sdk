...
// RestCountries SDK streaming feature
...
class RestCountriesStreamingFeature extends RestCountriesBaseFeature
{
    ...
    private function _iterate(RestCountriesResult $result): \Generator
    {
    ...
    private function _streamable(RestCountriesContext $ctx): bool
    {
