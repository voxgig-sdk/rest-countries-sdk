...
// RestCountries SDK ratelimit feature
...
class RestCountriesRatelimitFeature extends RestCountriesBaseFeature
{
    ...
    private function _acquire(RestCountriesContext $ctx): void
    {
    ...
    private function _track(RestCountriesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
