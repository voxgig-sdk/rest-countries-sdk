...
// RestCountries SDK proxy feature
...
class RestCountriesProxyFeature extends RestCountriesBaseFeature
{
    ...
    public function init(RestCountriesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RestCountriesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
