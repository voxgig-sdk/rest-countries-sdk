...
// RestCountries SDK idempotency feature
...
class RestCountriesIdempotencyFeature extends RestCountriesBaseFeature
{
    ...
    private function _mutating(RestCountriesContext $ctx): bool
    {
