...
class AllEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set RESTCOUNTRIES_TEST_ALL_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function all_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("RESTCOUNTRIES_TEST_ALL_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["RESTCOUNTRIES_TEST_ALL_ENTID"]);
