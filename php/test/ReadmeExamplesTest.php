...
// RestCountries SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RestCountriesSDK::test)
...
{
    private const SDK_CLASS = 'RestCountriesSDK';
    ...
    private const SDK_BASE = 'restcountries_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../restcountries_sdk.php';
