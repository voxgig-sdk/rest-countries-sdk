...
class CapitalDirectTest extends TestCase
{
    public function test_direct_load_capital(): void
    {
        $setup = capital_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-capital", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
