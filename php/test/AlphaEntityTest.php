...
class AlphaEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set RESTCOUNTRIES_TEST_ALPHA_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        [$alpha_ref01_data_dt0_loaded, $err] = $alpha_ref01_ent->load($alpha_ref01_match_dt0, null);
        $this->assertNull($err);
...
function alpha_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("RESTCOUNTRIES_TEST_ALPHA_ENTID");
