...
class AlphaDirectTest extends TestCase
{
    public function test_direct_load_alpha(): void
    {
        $setup = alpha_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-alpha", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
