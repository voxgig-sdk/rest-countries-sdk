...
class NameEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set REST_COUNTRIES_TEST_NAME_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function name_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("REST_COUNTRIES_TEST_NAME_ENTID");
