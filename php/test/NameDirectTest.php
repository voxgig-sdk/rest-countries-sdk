...
class NameDirectTest extends TestCase
{
    public function test_direct_load_name(): void
    {
        $setup = name_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-name", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
