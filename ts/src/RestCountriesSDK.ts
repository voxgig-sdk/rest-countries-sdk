...
class RestCountriesSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('RestCountriesSDK: graphql: ' +
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Alpha(entopts?: Record<string, any>) {
    const self = this
    return new AlphaEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Capital(entopts?: Record<string, any>) {
    const self = this
    return new CapitalEntity(self, entopts)
  }
