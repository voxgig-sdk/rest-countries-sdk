...
(0, node_test_1.describe)('AlphaEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(alpha_ref01_data_dt0.id === alpha_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/alpha/AlphaTestData.json');
    ...
    let idmap = transform(['alpha01', 'alpha02', 'alpha03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=AlphaEntity.test.js.map