...
(0, node_test_1.describe)('AlphaDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-alpha', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-alpha', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['REST_COUNTRIES_TEST_ALPHA_ENTID'];
...
//# sourceMappingURL=AlphaDirect.test.js.map