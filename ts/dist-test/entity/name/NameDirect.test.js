...
(0, node_test_1.describe)('NameDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.RestCountriesSDK({
    ...
    (0, node_test_1.test)('direct-load-name', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-name', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.REST_COUNTRIES_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'REST_COUNTRIES_TEST_NAME_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.RestCountriesSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['REST_COUNTRIES_TEST_NAME_ENTID'];
    ...
    const client = new __1.RestCountriesSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=NameDirect.test.js.map