...
(0, node_test_1.describe)('CapitalEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(capital_ref01_data_dt0.id === capital_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/capital/CapitalTestData.json');
    ...
    let idmap = transform(['capital01', 'capital02', 'capital03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    if (live) {
        const rawIds = process.env['REST_COUNTRIES_TEST_CAPITAL_ENTID'];
...
//# sourceMappingURL=CapitalEntity.test.js.map