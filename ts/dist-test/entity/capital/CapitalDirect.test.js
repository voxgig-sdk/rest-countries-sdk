...
(0, node_test_1.describe)('CapitalDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-capital', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-capital', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['REST_COUNTRIES_TEST_CAPITAL_ENTID'];
...
//# sourceMappingURL=CapitalDirect.test.js.map