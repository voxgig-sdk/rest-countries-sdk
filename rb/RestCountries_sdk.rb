...
require_relative 'RestCountries_types'
...
class RestCountriesSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = RestCountriesHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = RestCountriesHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, RestCountriesFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    RestCountriesUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = RestCountriesHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = RestCountriesHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = RestCountriesHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def raw_request(fetchargs = {})
    ...
    if fetched.is_a?(Hash)
      status = RestCountriesHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = RestCountriesError.new(
        "graphql_error", "RestCountriesSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = RestCountriesSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
