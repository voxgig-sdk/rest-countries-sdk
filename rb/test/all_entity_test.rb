...
class AllEntityTest < Minitest::Test
  ...
  def test_stream
    ...
    base = RestCountriesSDK.test(seed, nil)
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set REST_COUNTRIES_TEST_ALL_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def all_basic_setup(extra)
  ...
  entid_env_raw = ENV["REST_COUNTRIES_TEST_ALL_ENTID"]
