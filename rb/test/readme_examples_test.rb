...
#      offline in seeded test mode (RestCountriesSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "RestCountries_sdk.rb")
  SDK_CLASS = "RestCountriesSDK"
