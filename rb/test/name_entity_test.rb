...
class NameEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set REST_COUNTRIES_TEST_NAME_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def name_basic_setup(extra)
  ...
  entid_env_raw = ENV["REST_COUNTRIES_TEST_NAME_ENTID"]
