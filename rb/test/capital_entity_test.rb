...
class CapitalEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set RESTCOUNTRIES_TEST_CAPITAL_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def capital_basic_setup(extra)
  ...
  entid_env_raw = ENV["RESTCOUNTRIES_TEST_CAPITAL_ENTID"]
