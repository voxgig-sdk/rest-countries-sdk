...
class NameEntity
  ...
  # @return [Name, Hash] the current Name data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Name fields)
  def match_get
  ...
  # Load a single Name.
  #
  # @param reqmatch [NameLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Name.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Name, Hash] the loaded Name; raises RestCountriesError on failure
