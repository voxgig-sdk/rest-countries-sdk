...
const testSeed = `map[string]any{"entity": map[string]any{"all": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "alpha": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "capital": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "name": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
