...
func (sdk *RestCountriesSDK) OptionsMap() map[string]any {
...
func (sdk *RestCountriesSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *RestCountriesSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *RestCountriesSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RestCountriesSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *RestCountriesSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *RestCountriesSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("RestCountriesSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *RestCountriesSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RestCountriesSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("RestCountriesSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *RestCountriesSDK {
	...
	sdk := NewRestCountriesSDK(sdkopts)
	sdk.Mode = "test"
