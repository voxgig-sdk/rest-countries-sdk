...
The Golang SDK for the RestCountries API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/rest-countries-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/rest-countries-sdk=../path/to/github.com/voxgig-sdk/rest-countries-sdk
```
...
```
github.com/voxgig-sdk/rest-countries-sdk/
...
The root package (`github.com/voxgig-sdk/rest-countries-sdk`) re-exports everything needed
