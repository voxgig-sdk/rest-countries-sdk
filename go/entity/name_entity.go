...
func NewNameEntity(client *core.RestCountriesSDK, entopts map[string]any) *NameEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NameEntity) GetName() string { return e.name }
...
func (e *NameEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NameEntity) Deleted() bool {
	return e.deleted
}


func (e *NameEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNameEntity(e.client, opts)
}

func (e *NameEntity) Data(args ...any) any {
...
func (e *NameEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Name; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NameEntity) DataTyped(data ...Name) Name {
	if len(data) > 0 {
		return typedFrom[Name](e.Data(asMap(data[0])))
	}
	return typedFrom[Name](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Name (all fields
// optional at the wire level).
func (e *NameEntity) MatchTyped(match ...Name) Name {
	if len(match) > 0 {
		return typedFrom[Name](e.Match(asMap(match[0])))
	}
	return typedFrom[Name](e.Match())
}
...
func (e *NameEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NameEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NameLoadMatch and returns an Name. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *NameEntity) LoadTyped(reqmatch NameLoadMatch, ctrl map[string]any) (Name, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Name{}, err
	}
	return typedFrom[Name](res), nil
}



func (e *NameEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *NameEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NameEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NameEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NameEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
