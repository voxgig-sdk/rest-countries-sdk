...
func NewCapitalEntity(client *core.RestCountriesSDK, entopts map[string]any) *CapitalEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CapitalEntity) GetName() string { return e.name }
...
func (e *CapitalEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CapitalEntity) Deleted() bool {
	return e.deleted
}


func (e *CapitalEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCapitalEntity(e.client, opts)
}

func (e *CapitalEntity) Data(args ...any) any {
...
func (e *CapitalEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Capital; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CapitalEntity) DataTyped(data ...Capital) Capital {
	if len(data) > 0 {
		return typedFrom[Capital](e.Data(asMap(data[0])))
	}
	return typedFrom[Capital](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Capital (all fields
// optional at the wire level).
func (e *CapitalEntity) MatchTyped(match ...Capital) Capital {
	if len(match) > 0 {
		return typedFrom[Capital](e.Match(asMap(match[0])))
	}
	return typedFrom[Capital](e.Match())
}
...
func (e *CapitalEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CapitalEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CapitalLoadMatch and returns an Capital. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CapitalEntity) LoadTyped(reqmatch CapitalLoadMatch, ctrl map[string]any) (Capital, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Capital{}, err
	}
	return typedFrom[Capital](res), nil
}



func (e *CapitalEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CapitalEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CapitalEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CapitalEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CapitalEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
