...
func NewAlphaEntity(client *core.RestCountriesSDK, entopts map[string]any) *AlphaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AlphaEntity) GetName() string { return e.name }
...
func (e *AlphaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AlphaEntity) Deleted() bool {
	return e.deleted
}


func (e *AlphaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAlphaEntity(e.client, opts)
}

func (e *AlphaEntity) Data(args ...any) any {
...
func (e *AlphaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Alpha; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AlphaEntity) DataTyped(data ...Alpha) Alpha {
	if len(data) > 0 {
		return typedFrom[Alpha](e.Data(asMap(data[0])))
	}
	return typedFrom[Alpha](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Alpha (all fields
// optional at the wire level).
func (e *AlphaEntity) MatchTyped(match ...Alpha) Alpha {
	if len(match) > 0 {
		return typedFrom[Alpha](e.Match(asMap(match[0])))
	}
	return typedFrom[Alpha](e.Match())
}
...
func (e *AlphaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AlphaEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AlphaLoadMatch and returns an Alpha. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AlphaEntity) LoadTyped(reqmatch AlphaLoadMatch, ctrl map[string]any) (Alpha, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Alpha{}, err
	}
	return typedFrom[Alpha](res), nil
}



func (e *AlphaEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AlphaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AlphaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AlphaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AlphaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
