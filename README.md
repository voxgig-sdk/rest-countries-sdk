...
The REST Countries API provides detailed information about countries around the world in a simple RESTful interface.

Learn more about REST Countries API at [restcountries.com](https://restcountries.com).
...
This SDK exposes the API as a small set of **semantic entities** — All, Alpha, Capital and Name — that you
...
| **Alpha** | The Alpha entity (load). | `/alpha/{code}` |
| **Capital** | The Capital entity (load). | `/capital/{capital}` |
| **Name** | The Name entity (load). | `/name/{name}` |
