// Command RestCountries-mcp is an MCP server exposing the RestCountries
// SDK as MCP tools.
//
// Two tools are registered:
//
//	RestCountries_list  — list records of an entity
//	RestCountries_load  — load a single record of an entity
//
