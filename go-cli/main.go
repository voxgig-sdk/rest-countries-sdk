// Command RestCountries-cli is a CLI + REPL for the RestCountries SDK,
...
const prompt = "rest-countries"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "all alpha capital name"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      REST_COUNTRIES_APIKEY (api key), REST_COUNTRIES_BASE (base url override)")
