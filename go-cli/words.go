...
func registerSDKWords(r *eng.Registry, client *sdk.RestCountriesSDK) {
...
func runOp(client *sdk.RestCountriesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
