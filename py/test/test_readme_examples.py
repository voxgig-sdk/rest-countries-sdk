# RestCountries SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RestCountriesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RestCountriesSDK(...) and RestCountriesSDK.test(...) become
#      RestCountriesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "restcountries_sdk"
_SDK_CLASS = "RestCountriesSDK"
