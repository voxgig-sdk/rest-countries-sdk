...
from restcountries_sdk.utility import register

# Load features
from restcountries_sdk.feature.base_feature import RestCountriesBaseFeature
from restcountries_sdk.features import _has_feature, _make_feature
...
class RestCountriesSDK:
    ...
    def get_utility(self):
        return RestCountriesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("RestCountriesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def All(self, data=None) -> "AllEntity":
        ...
        from restcountries_sdk.entity.all_entity import AllEntity
        return AllEntity(self, data)


    def Alpha(self, data=None) -> "AlphaEntity":
        """Entity factory: client.Alpha().list() / client.Alpha().load({"id": ...})."""
        from restcountries_sdk.entity.alpha_entity import AlphaEntity
    ...
    def Capital(self, data=None) -> "CapitalEntity":
        ...
        from restcountries_sdk.entity.capital_entity import CapitalEntity
        return CapitalEntity(self, data)


    def Name(self, data=None) -> "NameEntity":
        """Entity factory: client.Name().list() / client.Name().load({"id": ...})."""
        from restcountries_sdk.entity.name_entity import NameEntity
