...
from restcountries_sdk.core.control import RestCountriesControl
...
from restcountries_sdk.core.helpers import get_ctx_prop, to_map
...
class RestCountriesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = RestCountriesControl()
        ...
        if isinstance(sp, RestCountriesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, RestCountriesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, RestCountriesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return RestCountriesError(code, msg, self)
